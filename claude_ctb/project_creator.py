...
class ProjectCreator:
    ...
    def create_project(self, initialize_git: bool = True, install_dev_kit: bool = False) -> Dict[str, Any]:
        """Create complete project with all features

        Note: install_dev_kit is deprecated and ignored (claude-dev-kit is no longer used)
        """
        try:
...
"""
    ...
    def create_project_simple(
        ...
        install_dev_kit: bool = False
    ) -> Dict[str, Any]:
        """Simple class method for creating projects

        Note: install_dev_kit is deprecated and ignored
        """
