...
#### C. 시스템 재시작
- claude-ctb 재시작 시 일부 기록이 초기화될 수 있음
...
## 🔗 관련 파일
- `claude_ctb/utils/session_summary.py:472` - 경고 메시지 출력 부분
- `claude_ctb/utils/wait_time_tracker.py:216-241` - has_completion_record() 메서드
